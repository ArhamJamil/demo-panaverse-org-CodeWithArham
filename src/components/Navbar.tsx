      ...
      <>
        <nav className='md:flex md:flex- md:justify-between  bg-gray-900 fixed w-full z-10 top-0  '>
          <div className='flex flex-row justify-around text-center md:block md:flex-none '>
            ...
            <button className=' my-6 px-2  md:hidden  ' onClick={handleClick}>
          ...
          <ul id='nav-list' className={ `${ active ? '' : 'hidden'} mx-8 my-2 py-4 px-2 bg-slate-700 md:flex md:my-4  md:bg-transparent md:py-3 `}>
            ...
            <li className='md:px-2 md:text-base font-normal text-white hover:text-red-600 md:transition md:ease-in-out md:delay-150 md:hover:-translate-y-1 md:hover:scale-110 md:duration-300 hover:bg-slate-600 my-2 py-2 px-4 md:hover:bg-transparent md:py-0'><Link href={"/contact"}>Contact</Link></li>
