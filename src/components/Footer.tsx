                        ...
                        <div className="flex flex-wrap md:text-left text-center order-first">
                            ...
                            <div className="lg:w-1/4 md:w-1/2 w-full px-3">
                                ...
                                <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                                    ...
                                    <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-red-600 border-0 py-2 px-6 focus:outline-none hover:bg-green-500 rounded">Submit</button>
                                </div>
                    ...
                    <div className="bg-gray-800 bg-opacity-75">
                        <div className="container px-3 py-6 mx-auto flex items-center sm:flex-row flex-col">
                            <a className="flex  font-medium items-center md:justify-start justify-center text-white">
                                <Image src={'/PanaverseLogo.png'} width={100} height={100} alt="" className=''></Image>
                                <span className="text-2xl">Panaverse DAO</span>
                            </a>
                            <p className="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4">© 2023 Panaverse DAO —
                                <a href="" className="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@CodeWithArham</a>
                            </p>
